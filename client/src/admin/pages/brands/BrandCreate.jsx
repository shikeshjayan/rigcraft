  ...
  return (
    <Box sx={{ p: 3 }}>
      <Box sx={{ display: "flex", alignItems: "center", gap: 1, mb: 3 }}>
        ...
        <Box>
          <Typography variant="h5" sx={{ fontWeight: 700, color: "var(--color-admin-text)" }}>New Brand</Typography>
          <Typography variant="body2" sx={{ color: "var(--color-admin-text-secondary)" }}>Add a new brand</Typography>
        </Box>
      </Box>
