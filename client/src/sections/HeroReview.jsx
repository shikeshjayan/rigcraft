          ...
          <motion.div
            ...
            <motion.div
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col">
                  <span className="text-[18px] font-[800] text-[#111111]">{selectedReview.name}</span>
                  <span className="text-[14px] font-medium text-[#6B7280]">{selectedReview.location} • Verified Purchase</span>
                </div>
              </div>
            </motion.div>
          </motion.div>
