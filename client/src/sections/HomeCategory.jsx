  ...
  >
    ...
    <div className="flex flex-col items-center justify-center h-full pt-2 relative p-2 md:p-3 w-full">
      ...
      <div className="mt-2 md:mt-3 text-center flex flex-col items-center">
        <h3 className="text-[11px] md:text-[12px] font-[700] text-[#111111] leading-tight">
          {cat.name}
        </h3>
        <p className="text-[9px] md:text-[10px] font-[500] text-[#6B7280] mt-1">
          {cat.products}
        </p>
      </div>
...
const MobileCategoryCard = ({ cat }) => (
  ...
  >
    ...
    <div className="flex-1 text-left flex flex-col justify-center">
      <h3 className="text-[15px] font-[700] text-[#111111] leading-none mb-1.5">
        {cat.name}
      </h3>
      <p className="text-[13px] font-[500] text-[#6B7280] leading-none">
        {cat.products}
      </p>
    </div>
  ...
  return (
    <section className="w-full pt-8 pb-0 md:py-20" style={{ backgroundColor: 'var(--color-bg-primary)' }}>
      <div className="max-w-[1400px] mx-auto px-6 lg:px-8">
              ...
              >
                <div className="bg-white border border-[#E5E7EB] shadow-[0_10px_40px_rgba(0,0,0,0.1)] p-4 flex flex-col" style={{ borderRadius: 'var(--radius-sm)' }}>
                  ...
                  <style>{`
                    ...
                    .mobile-category-scroll::-webkit-scrollbar-track {
                      background: #f1f1f1;
                      border-radius: 4px;
                    }
                  ...
                  `}</style>
                  <div className="mobile-category-scroll flex flex-col gap-2 overflow-y-auto max-h-[60vh] pr-2 pb-2">
        ...
        <div className="hidden md:grid md:grid-cols-5 lg:grid-cols-10 gap-3 xl:gap-4">
          {categories.map((cat, index) => (
